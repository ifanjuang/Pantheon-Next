...
Skills in this repository stay declarative. Executable scripts, installers, provider routers, queues and schedulers remain excluded by `docs/governance/HERMES_CODE_HOSTING_BOUNDARY.md`.
