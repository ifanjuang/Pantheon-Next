...
# Identities that ARE the system and can never be a human signer.
# Former implementation names remain deny-only reserved identities; they are not compatibility aliases. A signer
# matching any of these (case-insensitive) is a system-signer attempt.
SYSTEM_IDENTITIES = frozenset({
    "system", "runner", "hermes", "pantheon-app", "pantheon_app", "mvp-vertical", "mvp_vertical", "gate",
