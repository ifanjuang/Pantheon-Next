...
This clean post-#42 branch intentionally leaves `CHANGELOG.md`, `AUTHORITY_INDEX.md` and `MODULES.md` untouched to avoid replacing long index files through truncated tool output. Index integration can be handled in a later small reconciliation pass.
