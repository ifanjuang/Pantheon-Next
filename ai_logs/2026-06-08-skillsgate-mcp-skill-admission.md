...
Updated `docs/governance/CAPABILITY_REGISTRY.md` inside the rebased governed-composition branch instead of creating a new standalone doctrine document.

The `Skill admission guard` section states the core rule:
...
should be added after the capability registry branch is reviewed.
```
