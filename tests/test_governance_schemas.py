...
SCHEMA_TO_EXAMPLE = {
    ...
    "architecture-project-understanding/source_representation.schema.yaml": "architecture-project-understanding/source_representation.example.yaml",
    ...
    "architecture-project-understanding/relation_claim.schema.yaml": "architecture-project-understanding/relation_claim.example.yaml",
