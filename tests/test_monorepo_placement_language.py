...
def test_document_runtime_doctrine_uses_co_located_pantheon_adapter_placement() -> None:
    ...
    assert "repository: ifanjuang/pantheon-mvp" not in binding
    assert "repository: ifanjuang/pantheon-mvp" not in status
    assert "repository: ifanjuang/pantheon-mvp" not in observations
