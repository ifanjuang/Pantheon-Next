...
| `docs/governance/CORE_RECORDS_MODEL.md` | active support doctrine | implemented as documentation | Cross-domain record shapes and scope-keyed separation; shapes only, database is an external adapter. |
