...
| `docs/governance/CARD_STACK_KNOWLEDGE_CORPUS_ALIGNMENT.md` | candidate support note | documented non-implemented | Card-stack terminology alignment for Connaissance as non-project documentary corpus. Vocabulary alignment only; no UI, corpus engine, retrieval engine, approval engine, memory engine or runtime. |
