...
`docs/governance/authority/PANTHEON_SYSTEM_OWNERSHIP_REGISTRY.json` records the expected canonical owner of the principal concepts used across `Pantheon-Next`, `pantheon-mvp`, Hermes and Cockpit/OpenWebUI.
