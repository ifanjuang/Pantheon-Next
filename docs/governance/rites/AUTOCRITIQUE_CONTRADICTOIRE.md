...
1. Freeze the candidate output.
2. Extract claims.
3. Separate fact, interpretation and recommendation.
4. Identify unsupported claims.
5. Identify contradictions.
6. Identify seductive but unsafe phrasing.
7. Identify delivery, approval and memory implications.
8. Propose corrections or blocking conditions.
9. Assign ZEUS status.
...
- risk notes;
- correction actions;
- revised candidate if authorized;
