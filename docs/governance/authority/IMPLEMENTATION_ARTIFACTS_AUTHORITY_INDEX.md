...
Intended scope once rows migrate (separate PR, after coverage validation): implementation artifacts and protected paths: mcp-server/, docs/assets/, schemas/, tests/, platform/, operations/, Docker files, pyproject.toml and .env files.
