...
| `docs/governance/POSTGRES_PROPERTY_GRAPH_CAPABILITY.md` | candidate support doctrine | documented non-implemented | Optional PostgreSQL 19 SQL/PGQ Property Graph read-layer candidate for governed relationship inspection. No schema migration, graph runtime, installer, dependency adoption, approval engine, memory engine, Hermes execution, OpenWebUI feature commitment or central graph dependency. |
