...
Intended scope once rows migrate (separate PR, after coverage validation): Hermes-side adapters, OpenWebUI-facing surfaces, MCP candidate notes, browser/page-agent notes and external tool placement notes.
