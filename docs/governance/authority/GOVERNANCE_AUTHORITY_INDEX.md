...
Intended scope once rows migrate (separate PR, after coverage validation): canonical doctrine, active support doctrine, core governance candidates, status maps, request/workflow/memory/evidence doctrine and capability placement documents.
