...
docs/governance/examples/governed_loop_fixture/failing_external_action.fixture.yaml
...
```text
docs/governance/examples/governed_loop_fixture/validation_report.example.yaml
docs/governance/examples/governed_loop_fixture/failing_external_action.expected_report.yaml
```
...
validate central objects against schemas/governed_loop_objects.schema.yaml
