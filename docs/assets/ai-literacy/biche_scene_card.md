...
La Biche de Cerynie est un animal rapide, precieux et sacre.

Elle est liee a Artemis.

Hercule ne doit pas la tuer.

Il doit la capturer vivante.

Cette epreuve est tres differente du Lion ou de l'Hydre.

Face au Lion, Hercule doit affronter une force.

Face a l'Hydre, il doit trancher dans la proliferation.

Face a la Biche, il doit approcher sans brutaliser.

La difficulte n'est pas seulement de l'attraper.

La difficulte est de ne pas detruire ce qui fait sa valeur.
...
Il capture une intention vivante.
...
rester transparent
ne pas engager une faute de conception
ne pas accuser trop directement l'entreprise
preparer une decision
conserver la relation de confiance
...
Quelle prudence doit rester intacte ?
Quelle tension metier doit etre preservee ?
...
Y a-t-il un mode agentique avec etat, autonomie ou actions successives ?
```
