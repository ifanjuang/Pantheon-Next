# Ulysse et l’IA — identifier les pièges de notre rapport à une technologie devenue milieu

Status: support éditorial — document de travail conceptuel, non canonique, non exécutable.

Scope: cette note nourrit la partie `Ulysse` d’un support pédagogique sur l’IA. Elle sert à identifier les phénomènes, les égarements et les réflexes humains face à l’IA. Elle ne définit ni runtime, ni workflow, ni politique de sécurité, ni doctrine canonique de Pantheon Next.
...
## Carte synthétique des dix épisodes
...
Le premier piège consiste à mettre l’IA au centre du travail. On commence par elle, on reformule les problèmes selon ses capacités, on organise les documents autour de ce qu’elle peut produire, puis on finit par oublier que le centre réel demeure le métier, le contexte, le client, le patient, le justiciable, le projet, le code, l’ouvrage ou la décision à prendre.
...
McLuhan permet de nommer ce phénomène: le vrai effet d’un médium ne se limite pas aux contenus qu’il transmet. Il change les proportions, les rythmes, les formes d’association. L’IA n’est donc pas seulement un outil qui répond; elle modifie la manière de poser les questions. Heidegger, autrement, rappelle que la technique moderne tend à disposer le réel comme une réserve exploitable. Avec l’IA, tout semble immédiatement transformable: texte, image, plan, code, note, synthèse, voix, mémoire. C’est précisément pour cela qu’il faut décentrer.
...
```text
LOTOPHAGES
L’abondance engourdit le jugement
MESURE
```

### Résumé

L’IA produit plus vite que nous ne pouvons lire, trier, comparer, contrôler et assumer. Le piège n’est pas seulement de produire inutilement; il est de produire au-delà de notre capacité d’assimilation. L’abondance donne l’impression du travail accompli, mais elle peut suspendre la décision.

### Développement

Les Lotophages font oublier le retour. Dans notre rapport à l’IA, ils représentent la douceur de la production facile. Une demande produit dix variantes. Une image appelle quinze alternatives. Un plan se transforme en trois architectures d’article. Un mail devient plus poli, puis plus ferme, puis plus chaleureux, puis plus juridique, puis plus court. On ne travaille plus seulement sur la chose; on se laisse griser par la possibilité de la multiplier.

Herbert Simon fournit ici une clef décisive: l’abondance d’information consomme l’attention de ses destinataires. L’IA générative radicalise cette loi. Elle diminue le coût de production, mais elle ne diminue pas le coût humain de l’évaluation. Relire reste humain. Comprendre reste humain. Choisir reste humain. Assumer reste humain.

C’est un point central pour les professions de rigueur. Un avocat peut obtenir vingt formulations d’un argument, mais il doit encore savoir laquelle est juridiquement juste, prudente et utile. Un développeur peut obtenir plusieurs patchs, mais il doit encore comprendre les effets de bord. Un architecte peut obtenir des séries d’ambiances, mais il doit encore reconnaître celle qui sert réellement le projet et non seulement celle qui flatte l’œil.

Le piège est d’autant plus fort que la production donne une impression d’activité. On a rempli un dossier, généré des images, produit des notes, rédigé des variantes. Pourtant, l’avancement réel dépend d’une autre opération: intégrer, hiérarchiser, éliminer, retenir, décider. L’abondance devient brouillard lorsqu’elle dépasse la capacité de contrôle.
...
- Bernard Stiegler, travaux sur le pharmakon et l’attention.
- Erik Brynjolfsson, Danielle Li, Lindsey Raymond, “Generative AI at Work”, sur les gains réels mais différenciés de productivité.
- OpenAI, *Jobs in the Intelligence Age*, sur le déplacement du travail humain vers le jugement, la confiance et la supervision.
...
```text
CYCLOPE
Un seul œil ne voit qu’un monde
PLURALITÉ
```

### Résumé

Le piège du Cyclope est la vision unique. Un seul prompt, une seule source, une seule base documentaire, un seul modèle, une seule hypothèse ou une seule conversation peuvent produire une réponse cohérente mais étroite. Le danger n’est pas seulement l’erreur; c’est l’angle mort rendu convaincant.

### Développement

Le Cyclope voit puissamment, mais par un seul œil. Cette image est très juste pour l’IA. Une réponse peut être dense, nette, argumentée, bien structurée, tout en étant issue d’un champ de vision beaucoup trop pauvre. On croit avoir obtenu une vue d’ensemble; on n’a obtenu qu’une perspective.
...
- Pantheon Next, `KNOWLEDGE_TAXONOMY.md`, pour la séparation entre source, knowledge, retrieved knowledge, evidence et memory.

## 4. Éole — Ne jette pas la requête aux vents

### Sous-titres possibles

- La demande trop rapide
...
```text
ÉOLE
Ne jette pas la requête aux vents
MÉTICULOSITÉ
```
...
Éole garde les vents. Le danger commence lorsque le sac s’ouvre trop tôt. Dans le travail avec l’IA, ce sac est la requête: prompt, consigne, contexte, objectif, contrainte, format, rôle, niveau de risque. Tout cela peut être jeté en quelques secondes. Justement, c’est le problème.
...
- OpenAI, documentation sur la mémoire et les outils.
- Anthropic, “Effective context engineering for AI agents”.
...
- L’interface intime n’est pas un espace clos
...
```text
LESTRYGONS
La plateforme n’est pas un coffre
POROSITÉ
```

### Résumé

Le dialogue avec l’IA donne une impression d’intimité. On colle des documents, des extraits, des mails, des logs, des notes, des images, des informations sensibles. Pourtant une plateforme IA est un système: interface, serveurs, logs, mémoire, API, connecteurs, outils, prestataires, paramètres de confidentialité. Elle peut être sécurisée, mais elle n’est jamais magiquement close.

### Développement

Les Lestrygons dévorent. Dans notre rapport à l’IA, ils figurent l’ingestion. On donne de la matière pour obtenir une réponse plus précise. Plus on veut de pertinence, plus on donne. Le piège naît lorsque la commodité efface la question de l’exposition.
...
- OWASP, LLM Top 10, notamment “Sensitive Information Disclosure”.
- OpenAI, documentation sur MCP, outils et connecteurs.

## 6. Circé — La ressemblance n’est pas la fidélité

### Sous-titres possibles

- Transformer n’est pas conserver
...
```text
CIRCÉ
La ressemblance n’est pas la fidélité
FIDÉLITÉ
```

### Résumé

L’IA reformule, résume, clarifie, embellit, traduit, simplifie. Elle sait produire un texte qui ressemble à ce que l’on voulait. Mais ressembler n’est pas rester fidèle. À chaque passage, l’intention peut glisser: nuance, prudence, responsabilité, doute, niveau d’affirmation, ton.

### Développement

Circé transforme. Elle ne détruit pas toujours. Elle donne une autre forme. C’est exactement ce que fait l’IA générative dans une grande partie de nos usages quotidiens: elle prend une matière et lui donne une forme plus cohérente, plus fluide, plus professionnelle.

Le piège est que cette amélioration apparente nous rassure. Le texte est plus clair, donc il semble plus juste. Le mail est plus poli, donc il semble meilleur. La note est mieux structurée, donc elle semble plus solide. Le code est plus propre, donc il semble plus fiable. Mais la cohérence produite par l’IA n’est pas nécessairement la fidélité à l’intention de départ.
...
- Les traces anciennes parlent encore
...
```text
ENFERS
Le contexte se cherche dans les ombres
SITUATION
```

### Résumé

L’IA cherche du contexte. Si nous ne lui donnons pas le bon contexte, elle s’appuie sur ce qui est disponible: historique, mémoire, documents, base indexée, web, conversation précédente, patterns généraux, fragments. Ces traces peuvent aider, mais elles peuvent aussi être périmées, partielles, contradictoires ou hors périmètre.

### Développement

Aux Enfers, Ulysse consulte les ombres. Elles savent quelque chose, mais elles ne sont plus dans le monde des vivants. C’est une image puissante pour les systèmes de mémoire et de contexte.

L’IA ne travaille jamais dans le vide. Elle travaille avec un contexte: le prompt, la conversation, les fichiers fournis, les instructions, les documents retrouvés, la mémoire, parfois des outils ou des connecteurs. Lorsque ce contexte est pauvre ou mal situé, le système tente malgré tout de produire une continuité. Il rapproche, comble, devine, récupère.
...
- Anthropic, “Effective context engineering for AI agents”.
- OpenAI, documentation sur les mémoires.
- OWASP, risques liés aux vecteurs, embeddings et systèmes RAG.
- Pantheon Next, `MEMORY.md`, `SCOPE_ISOLATION.md` et `KNOWLEDGE_TAXONOMY.md`.

## 8. Sirènes — La belle forme peut noyer le vrai

### Sous-titres possibles

- L’envoûtement du rendu
...
```text
SIRÈNES
La belle forme peut noyer le vrai
DÉSENVOÛTEMENT
```

### Résumé

Les Sirènes ne représentent pas seulement l’absence de sources. Elles représentent l’envoûtement par les belles formes: formulation élégante, schéma net, image séduisante, mise en page propre, slide convaincante, code lisible, synthèse fluide. Le danger est de confondre qualité apparente du rendu et maturité du jugement.

### Développement

Les Sirènes chantent bien. Leur danger ne vient pas de la laideur, mais de la beauté. C’est pourquoi elles sont une image si juste pour l’IA générative. Le système peut produire des réponses belles, fluides, cohérentes, très convaincantes. Et c’est précisément cette cohérence qui baisse notre garde.
...
- CNIL, FAQ sur les hallucinations et réponses plausibles mais inexactes.
- NIST, *Generative AI Profile*, sur la confabulation et l’intégrité de l’information.

## 9. Charybde et Scylla — Chaque gain a son tribut

### Sous-titres possibles

- Ni adoration, ni rejet
...
```text
CHARYBDE ET SCYLLA
Chaque gain a son tribut
TRIBUT
```

### Résumé

Le piège est de penser en absolus: utiliser l’IA partout ou la rejeter en bloc. Chaque technologie a un coût, mais le non-usage a aussi un coût. La bonne question n’est pas pour ou contre l’IA, mais: pour quel usage, à quel prix, avec quelles limites, avec quelle supervision et avec quel revers ?

### Développement

Charybde et Scylla obligent à traverser entre deux dangers. C’est l’image la plus juste pour éviter le discours simpliste sur l’IA. L’enthousiasme naïf ne voit que le gain. Le rejet réflexe ne voit que le coût. Les deux aveuglent.

L’IA a des coûts: calcul, énergie, dépendance aux fournisseurs, standardisation des formes, risque de confidentialité, perte de compétence, dette de vérification, fragilité des chaînes d’outils, dilution de responsabilité. Mais ne pas l’utiliser a aussi des coûts: lenteur, fatigue, décrochage, incapacité à traiter l’abondance documentaire, difficulté à explorer plusieurs hypothèses, perte de compétitivité, isolement technique.

L’exemple de l’image est parlant. On critique souvent le coût de calcul de la génération IA. Cette critique est légitime. Mais elle doit être comparée proprement. Avant certaines générations IA, produire une image de synthèse, un rendu ou une simulation pouvait demander des heures ou des jours de calcul sur des machines puissantes. Le bon raisonnement n’est pas: “l’IA coûte, donc l’avant était propre”. Il est: “quel système coûte quoi, pour quel résultat, selon quelle qualité, quelle finalité, quelle fréquence et quelle alternative ?”

Stiegler permet de tenir cette ambivalence avec le concept de pharmakon: remède et poison. L’OCDE, le NIST, l’ANSSI, la CNIL et OWASP traduisent cette ambivalence en gouvernance: évaluer les risques, définir les usages, limiter les effets, maintenir la surveillance humaine, protéger les données, documenter les responsabilités.
...
- Anthropic, “Building effective agents”, sur les arbitrages entre simplicité, coût, autonomie et fiabilité.
- OpenAI, *A practical guide to building agents*, sur l’évaluation, les garde-fous et les coûts.
- NVIDIA, conférences et discours de Jensen Huang sur l’IA comme infrastructure industrielle.
...
```text
ITHAQUE
Déléguer n’abolit pas la réponse due
RESPONSABILITÉ
```

### Résumé

Ithaque rappelle que l’IA peut produire une sortie, mais non porter la décision à la place du professionnel. Une synthèse n’est pas un jugement. Une image n’est pas un projet. Un patch n’est pas une responsabilité assumée. Un conseil généré n’est pas encore un conseil professionnel.

### Développement

Le retour à Ithaque n’est pas le retour à un monde sans IA. C’est le retour au lieu où quelqu’un répond. Après les détours, les images, les formulations, les hypothèses, les sources, les mémoires et les agents, il reste une question simple: qui assume ?
...
La partie Ulysse ne doit pas être lue comme une dénonciation de l’IA. Ulysse n’est pas contre la mer. Il apprend à la traverser. Il rencontre des phénomènes qui existaient avant lui, mais qui deviennent des épreuves parce qu’il s’y expose. De même, l’IA ne crée pas à elle seule la hâte, la fascination, la paresse documentaire, la surproduction, la confusion entre forme et fond ou la tentation de déléguer. Elle les rend plus rapides, plus visibles, plus fréquents, parfois plus séduisants.

C’est pourquoi l’enjeu n’est pas de rejeter ce qui arrive. Le rejet pur serait lui-même un autre aveuglement. Cette technologie sera partout, et elle est déjà largement présente dans les environnements professionnels, documentaires, créatifs et logiciels. La vraie question est plus exigeante: comment évoluer activement dans ce nouveau milieu ?

La réponse commence par l’identification. Avant de construire une méthode, il faut aiguiser la perception. Reconnaître quand l’outil prend le centre. Sentir quand l’abondance dépasse notre capacité d’assimilation. Voir quand une réponse n’a qu’un seul œil. Ralentir la demande quand l’outil accélère la réponse. Comprendre que l’interface n’est pas un coffre. Distinguer ressemblance et fidélité. Situer les mémoires et les traces. Se désenvoûter des belles formes. Nommer le tribut de chaque gain. Revenir enfin à la responsabilité.

La planche Ulysse peut donc porter une fonction précise: former le regard avant de former la méthode. La méthode viendra ensuite, côté Hercule: évaluer, cadrer, nettoyer, filtrer, borner, autoriser, orchestrer, prouver, protéger. Mais avant la maîtrise, il faut la lucidité.

Phrase finale proposée pour le support:
...
- OCDE, Principes de l’IA: https://www.oecd.org/fr/themes/principes-de-l-ia.html
- CNIL, “Comment déployer une IA générative ?”: https://www.cnil.fr/fr/comment-deployer-une-ia-generative-la-cnil-apporte-de-premieres-precisions
...
- ANSSI / BSI, recommandations de sécurité concernant les assistants de programmation basés sur l’IA: https://cyber.gouv.fr/actualites/lanssi-et-le-bsi-publient-leurs-recommandations-de-s%C3%A9curit%C3%A9-concernant-les-assistants-de-programmation-bas%C3%A9s-sur-lia/
- OWASP, LLM Top 10: https://genai.owasp.org/llm-top-10/
- OWASP, Sensitive Information Disclosure: https://genai.owasp.org/llmrisk/llm06-sensitive-information-disclosure/
- OWASP, Excessive Agency: https://genai.owasp.org/llmrisk/llm08-excessive-agency/

### Industrie, agents, prompt, contexte et recherche augmentée

- OpenAI, “Introducing the Intelligence Age”: https://openai.com/global-affairs/introducing-the-intelligence-age/
...
- Erik Brynjolfsson, Danielle Li, Lindsey Raymond, “Generative AI at Work”: https://www.nber.org/papers/w31161
- NVIDIA, discours et conférences de Jensen Huang sur l’IA comme infrastructure industrielle: https://blogs.nvidia.com/blog/computex-2025-jensen-huang/

## Note éditoriale

Ce document est une base de rédaction et de storyboard. Les références doivent être revérifiées avant publication externe ou impression. Les correspondances entre épisodes mythologiques et phénomènes IA sont interprétatives: elles cherchent la fécondité pédagogique, pas l’exégèse canonique de l’Odyssée.
