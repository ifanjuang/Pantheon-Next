...
| [External MVP cockpit demo](https://github.com/ifanjuang/pantheon-mvp/blob/4ee41a845ec51db3118a584db0411a300450ccbd/mvp_vertical/cockpit/demo.html) | No-network synthetic-data demonstration using the actual `pantheon-mvp` cockpit CSS and JavaScript. When that external runtime is served, its path is `/cockpit/demo.html`. | Implemented externally at pinned commit `4ee41a845ec51db3118a584db0411a300450ccbd`; linked only; not copied, installed, served or activated by Pantheon Next. |
