...
- Governed night-operation cards are compact by default and reveal their state grid, activation conditions and Hermes technical controls in-place through an accessible show/hide control; only one card remains open at a time.
