...
- `architecture-project-understanding/` (candidate domain family: belief contract — shared vocabularies, stable_object, attribute_claim, calibration, derivation, evidence, doubt, contradiction, human_override, canonization; status/use vocabularies aligned with the proof register; see `docs/governance/ARCHITECTURE_PROJECT_UNDERSTANDING.md`)
